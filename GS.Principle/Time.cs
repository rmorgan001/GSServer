...
namespace GS.Principles
{
    public class Time : IDisposable
    {
        ...
        ///// Microsoft conversion of timespan
        ///// </summary>
        ...
        ///// <param name="dh">18.524166667</param>
        ///// <returns>31</returns>
        //public static int DHrs2Min(double dh)
        //{
        //    var a = Math.Abs(dh);
        //    var b = a * 3600;
        //    var c = Math.Round(b - 60 * Math.Floor(b / 60), 2);
        //    var d = Math.Abs(c - 60) < 0.0 ? b + 60 : b;
        //    var dHrs2Min = Math.Floor(d / 60) % 60;
        //    return Convert.ToInt32(dHrs2Min);
        //}
        ...
        ///// <summary>
        ///// Greenwich Mean Time to Local Side real Time
        ///// </summary>
        ...
        public static double Lst(double ejd, double jd, bool nutation, double longitude)
        {
            ...
            if (nutation)
            {
                ...
                //calculate L mean longitude of the Sun
        ...
        ///// <summary>
        ///// Creates a delayed timer using the media timer
        ///// </summary>
