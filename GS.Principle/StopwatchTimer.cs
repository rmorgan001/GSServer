...
//{
    ...
    ///// may be left unprotected of multithreaded access
    ///// </remarks>
    ...
    //    /// </summary>
    //    public event EventHandler<StopwatchTimerElapsedEventArgs> Elapsed;
    ...
    //    public StopwatchTimer(float interval)
    //    {
    //        Interval = interval;
    //    }
    ...
    //            Elapsed?.Invoke(this, new StopwatchTimerElapsedEventArgs(delay));
    ...
    //public class StopwatchTimerElapsedEventArgs : EventArgs
    //{
    //    /// <summary>/// Real timer delay in [ms]/// </summary>
    //    public double Delay { get; }

    //    internal StopwatchTimerElapsedEventArgs(double delay)
    //    {
    //        Delay = delay;
    //    }
    //}
